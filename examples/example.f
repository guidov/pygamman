        ...
        dimension tns(nlevels),pns(nlevels)
...
ccc
        ...
        print *
        do k = 1,n
          write(6,'(f8.2,3f10.4)') p(k),gamma(k),dgl(k),dgh(k)
        end do
...
ccc   
         ...
         if(i0.eq.1.and.j0.eq.1) then
            ...
            open(lun,file='llp.fdt',status='old',
     &           form='unformatted')
